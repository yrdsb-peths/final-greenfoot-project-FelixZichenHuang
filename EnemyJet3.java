...
public class EnemyJet3 extends Actor
{
    ...
    public void act()
    {
        ...
        // Remove this enemyJet3 object once it's hit by a MyMissile.class object, create an explosion object, play explosionSound, and increase score by one.
        ...
        // Remove this enemyJet3 object and create a new enemy jet when its x position is smaller than -200.
        if (getX() <= -200)
        {
